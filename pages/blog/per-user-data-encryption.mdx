---
title: 'Per-user data encryption | Charles Harries'
description: 'How I built per-user data encryption on Jernl.'
---

import Date from '../../components/Date';

<title>Per-user data encryption | Charles Harries</title>
<meta name="description" content="How I built per-user data encryption on Jernl." />
