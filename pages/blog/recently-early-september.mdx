...
The reason that it's hard for me to stop making type (1) websites is that the people who pay for me to make websites don't seem to care about type (2). They want Awwwards-ready websites, which, good luck finding a website on Awwwards that doesn't drive your CPU temperature up into the triple digits. _This website can be used by people across the world on just about any device_, is, however implausibly, a much harder sell than _This website will gobble up as many resources as your computer will let it_.
