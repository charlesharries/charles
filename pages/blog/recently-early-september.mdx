---
title: 'Recently: Early September | Charles Harries'
description: 'The web isn't about me, Umami.is, application holotypes, and utility programs'
---

import Image from '../../components/Image';
import Date from '../../components/Date';

<title>Recently: Early September | Charles Harries</title>
...
> Actually dovetails sort of nicely with the above, viz. the move on the web from a collection of interrelated, hyperlinked _documents_ to an Javascript-powered application experience. I think my _angst_ comes from building what is effectively a collection of hyperlinked documents (i.e. simple content sites) with full application frameworks (and the full application JS bundle that entails).
